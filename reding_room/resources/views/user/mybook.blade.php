				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					...
					<div class="row">
						...
						<ul class="product-list grid-products equal-container">
                            ...
                            @foreach($mbook as $row)
								@if($row->mcat == $mbookname)
										<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
										<div class="product product-style-3 equal-elem ">
											<div class="product-thumnail">
												<a href="#" title="{{$row->mbook_name}}">
													<!-- <figure><img src="assets/images/products/digital_20.jpg" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure> -->
													<figure><img src="{{url('File/images/'.$row->mbook_image)}}" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
												</a>
											</div>
											<div class="product-info">
												<a href="#" class="product-name"><span>{{$row->mbook_name}}</span></a>
												<div class="wrap-price"><span class="product-price">$250.00</span></div>
												<!-- <a href="#" class="btn add-to-cart">Add To Cart</a>
												<a href="#" class="btn add-to-cart">Add To Mybook</a> -->

												<a href="/mbshow/{{$row->mbook_name}}"class="btn add-to-cart" >Read</a>
											</div>
										</div>
									</li>
								@endif
