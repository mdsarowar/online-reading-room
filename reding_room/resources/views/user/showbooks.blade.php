								...
								@if($row->cat == $cat)
										...
										<div class="product product-style-3 equal-elem ">
											<div class="product-thumnail">
												<a href="#" title="{{$row->book_name}}">
													<!-- <figure><img src="assets/images/products/digital_20.jpg" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure> -->
													<figure><img src="{{url('File/images/'.$row->book_image)}}" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
												</a>
											</div>
											<div class="product-info">
												<a href="#" class="product-name"><span>{{$row->book_name}}</span></a>
												<div class="wrap-price"><span class="product-price">$250.00</span></div>
												<!-- <a href="#" class="btn add-to-cart">Add To Cart</a> -->
												<a href="/addmybook/{{$row->id}}" class="btn add-to-cart">Add To Mybook</a>

												<a href="/show/{{$row->id}}"class="btn add-to-cart" >Read</a>
											</div>
										</div>
									</li>
								@endif
